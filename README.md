<div><img style="vertical-align: middle !important; padding-right: 10px" src="./static/assets/img/portfolio/fullsize/AI.png" height="70px" weight="70px">Project 3 - Convolutional Neural Network</div>
